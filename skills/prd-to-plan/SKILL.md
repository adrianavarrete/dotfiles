...
Create `.agents/plans` if it doesn't exist. Write the plan as a Markdown file named after the feature (e.g. `.agents/plans/user-onboarding.md`). Use the template below.
